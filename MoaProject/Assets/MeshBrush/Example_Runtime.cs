...
public class Example_Runtime : MonoBehaviour {
    ...
    void Start()
    {
        ...
        // Remember:    this is really just a simple example script and the variables 
        //              that I am horribly setting here inside the start function are for testing purposes only!
        ...
        // It's up to you how you set up all these variables. 
        // I didn't give a value to all of them (for instance, I didn't use the slope filter at all here).
        // You could for example create an in game interface where the player has to set up these variables 
        // (or you could also do that behind the player's back).
        //
