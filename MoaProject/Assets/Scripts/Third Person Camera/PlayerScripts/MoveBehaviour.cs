...
public class MoveBehaviour : GenericBehaviour
{
    ...
    private bool eat;                               // Boolean to determine whether or not the player can eat.
    private bool stone;                             // Boolean to determine whether or not the player can pickup stones.
    ...
    Vector3 Rotating(float horizontal, float vertical)
    {
        ...
        Debug.DrawLine(transform.localPosition, transform.localPosition + targetDirection, Color.red);
